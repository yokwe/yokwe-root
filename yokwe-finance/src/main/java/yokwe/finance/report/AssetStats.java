...
public class AssetStats {
	...
	@Sheet.HeaderRow(0)
	@Sheet.DataRow(1)
	public static class DailyCompanyGeneralReport extends Sheet {
		...
		public DailyCompanyGeneralReport() {}
		public DailyCompanyGeneralReport(
			String date,
			String company,
			double total,
		...
		public void add(DailyCompanyGeneralReport that) {
			this.total   += that.total;
			this.jpy     += that.jpy;
		...
		public DailyCompanyGeneralReport percent(double grandTotal) {
			var ret = new DailyCompanyGeneralReport();
			ret.date    = this.date;
			ret.company = this.company;
			ret.total   = this.total   / grandTotal;
