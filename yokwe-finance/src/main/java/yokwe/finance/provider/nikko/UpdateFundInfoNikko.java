...
public class UpdateFundInfoNikko {
	...
	public static class FundList {
		...
		public static class Data {
			...
			@Name("ChangeValueRaw")               public int        ChangeValueRaw;
			...
			@Name("DividendProfitRaw")            public int        DividendProfitRaw;
			@Name("DividendTimes")                public String     DividendTimes;
			@Name("DividendYears")                public String     DividendYears;
			@Name("DividendYearsRaw")             public int        DividendYearsRaw;
			...
			@Name("NetAssetValueRaw")             public int        NetAssetValueRaw;
			...
			@Name("NikkoSort")                    public String     nikkoSort;
			@Name("QuickFundRisk")                public String     QuickFundRisk;
			@Name("ReferenceDate")                public String     ReferenceDate;
			@Name("ReturnMonth1Raw")              public int        ReturnMonth1Raw;
			@Name("ReturnMonth3")                 public String     ReturnMonth3;
			@Name("ReturnMonth3Raw")              public int        ReturnMonth3Raw;
			@Name("ReturnMonth6Raw")              public int        ReturnMonth6Raw;
			@Name("ReturnSettingRaw")             public int        ReturnSettingRaw;
			@Name("ReturnYear1")                  public String     ReturnYear1;
			@Name("ReturnYear10Raw")              public int        ReturnYear10Raw;
			@Name("ReturnYear1Raw")               public int        ReturnYear1Raw;
			@Name("ReturnYear3Raw")               public int        ReturnYear3Raw;
			@Name("ReturnYear5Raw")               public int        ReturnYear5Raw;
			...
			@Name("TotalAssetValueRaw")           public int        TotalAssetValueRaw;
