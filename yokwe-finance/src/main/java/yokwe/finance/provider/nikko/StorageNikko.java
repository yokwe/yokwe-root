...
public class StorageNikko {
	...
	// fund-info-nikko
	public static final Storage.LoadSave<FundInfoNikko, String> FundInfoNikko =
		new Storage.LoadSave.Impl<>(FundInfoNikko.class,  o -> o.isinCode, storage, "fund-info-nikko.csv");
}
