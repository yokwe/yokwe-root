...
public class T102 {
	static final org.slf4j.Logger logger = LoggerFactory.getLogger(T102.class);
	...
	public static class FieldArray extends Field {
		...
		public final Map<String, Field> map = new TreeMap<>();
				...
				for(JsonValue jsonValue: jsonArray) {
					...
					if (valueType == ValueType.OBJECT) {
						...
						for(String fieldName: jsonObject.keySet()) {
							...
							ValueType fieldType = jsonValue.getValueType();
		...
		@Override
		public String toString() {
			return String.format("{%s %s %s %s}", type, name, size, map.size());
		}
		@Override
		public boolean equals(Object object) {
